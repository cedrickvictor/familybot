		...
		<div class="top-bar_sub_w3layouts container-fluid">
			<div class="row">
				...
				<div class="col-md-4 top-forms text-center mt-lg-3 mt-md-1 mt-0">
					<span>MURAKAZE NEZA!</span>
					<span class="mx-lg-4 mx-md-2  mx-1">
						<a href="blogadmin/index.php">
							<i class="fas fa-lock"></i> <strong>Injira</strong></a>
					</span>
					<span>
						<a href="blogadmin/membership_signup.php">
							<i class="far fa-user"></i> <strong>Iyandikishe</strong></a>
					</span>
				</div>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item active">
								<a class="nav-link" href="index.php">Ahatangira
									<span class="sr-only">(current)</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="about.php">Ibyo dukora</a>
							</li>
							...
							<li class="nav-item">
								<a class="nav-link" href="contact.php">Tuvugishe</a>
							</li>

						</ul>
							<form action="search.php" method="post" class="form-inline my-2 my-lg-0 header-search" name="form">
								<input class="form-control mr-sm-2" type="search" placeholder="Shakira Hano..." required="yes" type="text" name="search[keyword]">
